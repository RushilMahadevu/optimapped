        ...
        >
          ...
          >
            <motion.button
              ...
              disabled={isLoading}
              className={`w-full flex items-center justify-center gap-3 py-3 rounded-lg bg-background border border-gray-700 text-foreground text-sm hover:bg-gray-900 transition-colors ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'}`}
